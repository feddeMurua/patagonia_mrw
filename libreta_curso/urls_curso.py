...
urlpatterns = [
    ...
    url(r'^pdf/(?P<pk>\d+)$', PdfAprobados.as_view(), name='pdf_aprobados'),
    ...
    url(r'^pdf/(?P<pk>\d+)$', PdfAsistencia.as_view(), name='pdf_asistencia'),    
    url(r'^opciones', opciones_estadisticas, name='opciones_estadisticas')
]
