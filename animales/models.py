...
class Porcino(models.Model):	
    ...
    categoria = models.CharField(max_length=15, choices=Categoria_Porcino)
...
class ControlAntirrabico(models.Model):
    ...
    responsable = models.OneToOneField(m.PersonaFisica, on_delete=models.SET_NULL, null=True, blank=True, related_name="responsable")
