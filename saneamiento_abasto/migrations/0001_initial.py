# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-10-02 16:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_kg', models.IntegerField(validators=[django.core.validators.MinValueValidator(1)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marca', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='saneamiento_abasto.MarcaVehiculo')),
